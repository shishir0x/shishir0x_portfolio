...
package name to whatever we want, in our case it is called `@shishir0x/playground`

```json
"name": "@shishir0x/playground",
...
Boom, you are done! you can now check our NPM account for our new package [@shishir0x/playground](https://www.npmjs.com/package/@shishir0x/playground).
